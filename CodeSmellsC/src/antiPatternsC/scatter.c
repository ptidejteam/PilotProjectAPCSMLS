...
#include "..\..\..\CodeSmellsJNI\bin\headers\antiPatternsJava_scatter_RGB888Image.h"
#include "..\..\..\CodeSmellsJNI\bin\headers\antiPatternsJava_scatter_YUV420Image.h"
#include "..\..\..\CodeSmellsJNI\bin\headers\antiPatternsJava_scatter_YUV444Image.h"
...
JNIEXPORT jobject JNICALL Java_antiPatternsJava_scatter_RGB888Image_toYuv420(
		JNIEnv*env, jobject thisImage) {
	jclass imageClass = (*env)->FindClass(env,
			"antiPatternsJava/scatter/YUV420Image");
...
JNIEXPORT jobject JNICALL Java_antiPatternsJava_scatter_RGB888Image_toYuv444(
		JNIEnv*env, jobject thisImage) {
	jclass imageClass = (*env)->FindClass(env,
			"antiPatternsJava/scatter/YUV444Image");
	jobject image = (*env)->AllocObject(env, imageClass);
	copyWidthHeight(env, imageClass, thisImage, image); // transform RGB888 to YUV444 format ...
	return image;
}

JNIEXPORT jobject JNICALL Java_antiPatternsJava_scatter_YUV420Image_toRgb888(
		JNIEnv*env, jobject thisImage) {
	jclass imageClass = (*env)->FindClass(env,
			"antiPatternsJava/scatter/RGB888Image");
	jobject image = (*env)->AllocObject(env, imageClass);
	copyWidthHeight(env, imageClass, thisImage, image); // transform YUV420 to RGB888 format ...
	return image;
}

JNIEXPORT jobject JNICALL Java_antiPatternsJava_scatter_YUV420Image_toYuv444(
		JNIEnv*env, jobject thisImage) {
	jclass imageClass = (*env)->FindClass(env,
			"antiPatternsJava/scatter/YUV444Image");
	jobject image = (*env)->AllocObject(env, imageClass);
...
JNIEXPORT jobject JNICALL Java_antiPatternsJava_scatter_YUV444Image_toRgb888(
		JNIEnv*env, jobject thisImage) {
	jclass imageClass = (*env)->FindClass(env,
			"antiPatternsJava/scatter/RGB888Image");
	jobject image = (*env)->AllocObject(env, imageClass);
...
JNIEXPORT jobject JNICALL Java_antiPatternsJava_scatter_YUV444Image_toYuv420(
		JNIEnv*env, jobject thisImage) {
	jclass imageClass = (*env)->FindClass(env,
			"antiPatternsJava/scatter/YUV420Image");
	jobject image = (*env)->AllocObject(env, imageClass);
